...
public class WaitForGameActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		GameProperties gameProps = (GameProperties) getIntent().getSerializableExtra(getResources().getString(R.string.gamePropertiesStr));
		GameClient gameClient = (GameClient) getIntent().getSerializableExtra(getResources().getString(R.string.gameClientStr));
	...
	private void setGameInfo(GameProperties gameProps) {
		...
		String categoriesStr = arrayOfCategoriesToString(gameProps.getCategories());
